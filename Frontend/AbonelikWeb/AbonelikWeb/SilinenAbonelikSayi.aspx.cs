...
{
    public partial class SilinenAbonelikSayi : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label2.Text = "Silinen Abonelik Sayıları : ";


            ///////////// Silinen_Abonelik_Sayi Getirme.
            ...
            SqlDataReader dr2;
            komut2.CommandText = "Select d.ad,ds.dergi_sayi,ds.tarih,ds.link from Dergi_Sayisi ds inner join Silinen_Abonelik sa on ds.dergi_id=sa.dergi_id inner join Dergi d on sa.dergi_id = d.id where (sa.abonelik_id=" + abonelik + " and (tarih between (Select baslangic_tarih from Silinen_Abonelik where abonelik_id=" + abonelik + ") and (Select bitis_tarih from Silinen_Abonelik where abonelik_id=" + abonelik + "))) order by ds.dergi_sayi" ;
