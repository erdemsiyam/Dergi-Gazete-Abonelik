...
{
    public partial class SilinenAbonelik : System.Web.UI.Page
    {
        int kullanici_id;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label2.Text = "Silinen Abonelikler : ";
            ...
            SqlDataReader dr2;
            komut2.CommandText = "select a.abonelik_id,d.ad,a.baslangic_tarih,DATEADD(day,taahut_gun+1,a.baslangic_tarih) as bitis_tarih from Silinen_Abonelik a inner join dergi d on a.dergi_id=d.id where a.kullanici_id=" + kullanici_id.ToString();
            ...
            tablo.Append("<tr><th>Dergi İsmi</th><th>Başlangıç Tarih</th><th>Bitiş Tarihi</th><th></th></tr>");
            ...
            if (dr2.HasRows)
            {
                while (dr2.Read())
                {
                    ...
                    tablo.Append("<td><a href=\"SilinenAbonelikSayi.aspx?id="+kullanici_id+"&abonelik=" + dr2[0] + "\">Sayilara Bak</a></td>");
                    tablo.Append("</tr>");
                }
            }
            tablo.Append("</table>");
